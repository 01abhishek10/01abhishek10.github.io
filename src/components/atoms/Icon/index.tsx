...
type IconName = "github" | "linkedin" | "email" | "external" | "menu" | "close";
...
/**
 * Icon atom - SVG icon component with common icons.
 * @param name - Icon identifier: "github" | "linkedin" | "email" | "external" | "menu" | "close"
...
export default function Icon({ name, size = 24, className = "", ...props }: IconProps) {
  ...
  const isStroke = ["external", "menu", "close"].includes(name);
